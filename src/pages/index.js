    ...
    <>
      ...
      <Container>
        ...
        {/* <Container>
          ...
          <TechContainer>
            <Hexagon time={Math.random() * 5} onClick={disperse}>
            ...
            <Hexagon time={Math.random() * 5} onClick={disperse}>
              <Icon className="fas fa-terminal"></Icon>
            </Hexagon>
            <Hexagon time={Math.random() * 5} onClick={disperse}>
              <Icon className="fas fa-code-branch"></Icon>
            </Hexagon>
            <Hexagon time={Math.random() * 5} onClick={disperse}>
              <Icon className="fab fa-vuejs"></Icon>
            </Hexagon>
            <Hexagon time={Math.random() * 5} onClick={disperse}>
              <Icon className="fas fa-drafting-compass"></Icon>
            </Hexagon>
          </TechContainer>
        </Container> */}
      </Container>
